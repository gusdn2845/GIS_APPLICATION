        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="inpShpFile" class="form-label"><p class="text-danger">ZIP 파일만 등록 가능합니다.</p></label>
                        <input class="form-control" type="file" id="inpShpFile" accept=".zip">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">닫기</button>
                    <button type="submit" id="btnShpUpload" class="btn btn-primary">확인</button>
                </div>
            </div>
        </div>
    </form>
